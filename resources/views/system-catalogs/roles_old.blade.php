                            ...
                            <td class="text-end">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                    <div class="menu-item px-3">
                                        <a class="menu-link px-3" onclick="editRecord('{{ $role->id_role }}')">
                                             Edit
                                        </a>
                                    </div>
                                    <div class="menu-item px-3">
                                        <a href="#" class="menu-link px-3" id="{{ $role->id_role }}" data-kt-users-table-filter="delete_row">Delete</a>
                                    </div>
                                </div>
                                <!--end::Menu-->
                            </td>
        ...
        var KTUsersList=function(){
            ...
            c=()=>{
                o.querySelectorAll('[data-kt-users-table-filter="delete_row"]').forEach((t=>{
                        ...
                        let id_role = (n.querySelectorAll("td")[3].querySelectorAll("a")[2]).id;
                    ...
                    (()=>{
                        var o=FormValidation.formValidation(e,{
                            fields:{
                                ...
                                description:{validators:{notEmpty:{message:"Password is required"}}},
                            },
