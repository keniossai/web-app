                        ...
                        <div class="px-7 py-5" data-kt-user-table-filter="form">
                            ...
                            <div class="mb-10">
                                ...
                                <select class="form-select form-select-solid fw-bold" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-user-table-filter="role" data-hide-search="true">
                                    <option></option>
                                    @foreach (App\models\Action::where('active', 1)->get()->unique('module') as $action)
                                        <option value="{{ $action->module }}">{{ $action->module }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <!--end::Input group-->
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex flex-column">
                                    <a href="#" class="text-gray-800 text-hover-primary mb-1">{{ $action->module }}</a>
                                    <span></span>
                                </div>
                            </td>
                            <td>{{ $action->name }}</td>
                            ...
                            <td class="text-end">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                    <div class="menu-item px-3">
                                        <a class="menu-link px-3" onclick="editRecord('{{ $action->id_action }}')">
                                             Edit
                                        </a>
                                    </div>
                                    <div class="menu-item px-3">
                                        <a href="#" class="menu-link px-3" id="{{ $action->id_action }}" data-kt-users-table-filter="delete_row">Delete</a>
                                    </div>
                                </div>
                                <!--end::Menu-->
                            </td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    ...
                    <form id="kt_modal_add_user_form" class="form" action="#">
                        <!--begin::Scroll-->
                        <input id="id_action" name="id_action" value="" hidden>
                        @csrf
                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                            <div class="fv-row mb-7">
                                <label class="required fw-semibold fs-6 mb-2">Module</label>
                                <input type="text" name="module" id="module" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Module" value="" />
                            </div>
                            <div class="fv-row mb-7">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <textarea class="form-control form-control-solid mb-8" rows="3"  name="description" id="description" placeholder="Description"></textarea>
                            </div>
                        </div>
        ...
        var KTUsersList=function(){
            ...
            c=()=>{
                o.querySelectorAll('[data-kt-users-table-filter="delete_row"]').forEach((t=>{
                        ...
                        let id_action = (n.querySelectorAll("td")[4].querySelectorAll("a")[2]).id;
                                    ...
                                    setTimeout((function(){
                                        ...
                                        $.ajax({
                                            ...
                                            success:function(response){
                                                ...
                                                if(response){
                                                    Swal.fire({
                                                        text:"Registered action successfully!",
                                                        icon:"success",
                                                        buttonsStyling:!1,
                                                        confirmButtonText:"Ok, got it!",
    ...
    <script>
        ...
        function editRecord(id){
            $.ajax({
                ...
                method: 'post',
                data: { 'id_action' : id },
                url: '{{ route('read-action') }}',
                success:function(response){
                    $('#id_action').val(response.id_action);
