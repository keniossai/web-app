...
@section('master-title', 'Permissions')
                ...
                <tbody class="text-gray-600 fw-semibold">
                    @foreach ($permissions as $permission)
                        <tr>
                            ...
                            <td>{{ $permission->action->module }}</td>
                            <td>
                                <div class="d-flex flex-column">
                                    <a href="#" class="text-gray-800 text-hover-primary mb-1">{{ $permission->action->name }}</a>
                                    <span></span>
                                </div>
                            </td>
                            ...
                            <td class="text-end">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                    <div class="menu-item px-3">
                                        <a class="menu-link px-3" onclick="editRecord('{{ $permission->id_permission }}')">
                                             Edit
                                        </a>
                                    </div>
                                    <div class="menu-item px-3">
                                        <a href="#" class="menu-link px-3" id="{{ $permission->id_permission }}" data-kt-users-table-filter="delete_row">Delete</a>
                                    </div>
                                </div>
                                <!--end::Menu-->
                            </td>
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header" id="kt_modal_add_user_header">
                    <!--begin::Modal title-->
                    <h2 class="fw-bold">Permission</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                    <div class="btn btn-icon btn-sm btn-active-icon-primary" data-kt-users-modal-action="close">
                        <!--begin::Svg Icon | path: icons/duotune/arrows/arr061.svg-->
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    ...
                    <form id="kt_modal_add_user_form" class="form" action="#">
                        <!--begin::Scroll-->
                        <input id="id_permission" name="id_permission" value="" hidden>
                        @csrf
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <select class="form-select form-select-solid" data-control="select2" id="id_action" name="action" data-dropdown-parent="#kt_modal_add_user_form" data-placeholder="Select an action" data-allow-clear="true" required>
                                    @foreach (App\models\Action::orderBy('name')->where('active', 1)->get() as $action)
                                        <option value="{{ $action->id_action }}">{{ $action->module }} [{{ $action->name }}]</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
        ...
        var KTUsersList=function(){
            ...
            c=()=>{
                o.querySelectorAll('[data-kt-users-table-filter="delete_row"]').forEach((t=>{
                        ...
                        //obtengo la columna de id para eliminar
                        let id_permission = (n.querySelectorAll("td")[3].querySelectorAll("a")[2]).id;
                                            ...
                                            confirmButton:"btn fw-bold btn-primary"}}).then((function(){
                                                ...
                                                buttonsStyling:!1,confirmButtonText:"Ok, got it!",customClass:{
                                                    ...
                                                    return{init:function(){o&&(o.querySelectorAll("tbody tr").forEach((e=>{
                                                        ...
                                                        t[2].setAttribute("data-order",l)})),(e=$(o).DataTable({
                                                            info:!1,order:[],pageLength:10,lengthChange:!1,
                                                            //target especificar cantidad de columnas
                                                            columnDefs:[{orderable:!1,targets:0},{orderable:!1,targets:3}]})).on("draw",(function(){l(),c(),a()})),l(),
                ...
                init:function(){
                    (()=>{
                        var o=FormValidation.formValidation(e,{
                            fields:{
                                role:{validators:{notEmpty:{message:"Full name is required"}}},
                                action:{validators:{notEmpty:{message:"Password is required"}}},
                            },
                                    ...
                                    setTimeout((function(){
                                        ...
                                        $.ajax({
                                            ...
                                            data: { 'id_role' : $('#id_role').val(),
                                                    ...
                                                    'id_permission' : $('#id_permission').val()
                                                },
                                            ...
                                            success:function(response){
                                                ...
                                                if(response){
                                                    Swal.fire({
                                                        text:"Registered role successfully!",
                                                        icon:"success",
                                                        buttonsStyling:!1,
                                                        confirmButtonText:"Ok, got it!",
    ...
    <script>
        ...
        function editRecord(id){
            $.ajax({
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
                method: 'post',
                data: { 'id_permission' : id },
                url: '{{ route('read-permission') }}',
                success:function(response){
                    console.log(response);
                    $('#id_permission').val(response.id_permission);
